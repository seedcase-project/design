...
[new](https://github.com/seedcase-project/design/issues/new/choose) issue on our
GitHub repository.
...
To contribute to `design`, you first need to install
...
will revise the pull request title to follow that format, as we use squash
merges when merging pull requests, so all other commits in the pull request will
be squashed into one commit.
