...
[new](https://github.com/seedcase-project/design/issues/new/choose)
...
Git messages. If you don't use Conventional Commits when making a commit, we will revise the
