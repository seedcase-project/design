...
description: "Guidelines on how to write tests of our Python code"
---
...
- If there's multiple functions in the same script, you can include
...
1. Arrange: Set up the test data and any other necessary conditions.
2. Act: Call the function or method being tested.
3. Assert: Check the output of the function or method.

This is sometimes called "Given, When, Then".
