...
which we then use TDD to write some basic tests for user-facing code,
...
2.  **Code-level design of user functionality**: This step is about
    building up and deciding on explicit naming of the code-level of
    ...
    interact with. This is where brainstorm and agree on the types of
...
4.  **Wireframes of the user interface (for projects with an UI)**: Once
...
5.  **URL paths and HTML templates (for projects with an UI)**: Finally,
