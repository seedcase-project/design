...
This section is an overview of the potential human and computer partners
the Seedcase framework communicates with during operation. Human
communication partners are grouped into user roles which are broadly
applicable to the entire Seedcase framework. For a detailed discussion
of these user roles, see [User Requirements](user-requirements.qmd).
Whether any computer communication partners are present for a particular
Seedcase installation depends on the specific needs or requirements of
the Data Resource managed by Seedcase.
