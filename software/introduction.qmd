...
The Seedcase framework is developed and designed with four users and their associated
use cases in mind. The four users, which are described in more detail
on the [User Requirements](user-requirements.qmd) page, are:
