...
values guide the development of Seedcase software, unexamined and
...
developing Seedcase software:

1.  Follow [FAIR](https://www.go-fair.org/fair-principles/) (Findable,
    Accessible, Interoperable, and Reusable), open, and transparent
    principles for the framework itself and to enable FAIR principles in
    the database.
...
framework, we will use software and tools underlying Seedcase products
that fit these principles:
...
uses cases in mind. The four users, which are described in more detail
in the [Context section](context.qmd), are:
