...
resources used widely in industry that haven't been incorporated
...
make use of and/or modify open software and resources for our projects wherever possible.
...
full-time IT professionals, there is a rich ecosystem of tools they can draw on and use
for nearly any purpose. However, technically knowledgeable non-specialists
may not have the same resources or knowledge to know how to use
these tools. We want to build software and products in a way that
encourages more contributions from people outside our team, which can help us maintain
and develop our products while also (hopefully) leading to greater use.
So we aim to use tools and knowledge that as many 
potential contributors and future team members are at least familiar
with or soon to be familiar with when building our products.
At the same time, we will also embrace and seek out less established or newer tools
that are a substantial improvement over existing or more widely used tools.
That way we can balance being accessible, while also being as productive and 
effective as we can given our resources, time, and knowledge.
...
likely to have bugs because they can be harder to test. They also aren't as
...
to be easier to reason about, develop, and most importantly test. This is
