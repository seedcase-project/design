...
2.  [Principles](principles.qmd): Targeted at any reader. Covers the
    core values and guiding principles that direct and shape many
    aspects of the architecture of Seedcase software as well as the
...
3.  [Context and scope](context.qmd): Targeted at any reader. Defines the boundaries of the Seedcase framework by listing its human and computer communication partners, and describing, in general terms, the messages exchanged between them.
...
10. [Architecture decisions](../decisions.qmd): Targeted at technical
    readers. Covers the reasons for decisions we make about specific
