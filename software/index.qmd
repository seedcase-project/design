...
for nearly any purpose. However, technically knowledgable non-specialists
may not have the same resources or knowledge to use
...
when developing software. So we aim use tools and knowledge that have as wide
