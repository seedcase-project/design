...
our general approach to how we build and develop it. The documents
include (so far) our values towards software design, which are described
below, and [principles](principles.qmd), which are informed by our
values.
