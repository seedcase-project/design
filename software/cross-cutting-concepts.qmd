...
<!-- TODO: Insert real links to Sprout below -->
...
have a set of tasks and corresponding permission levels that a user can be assigned,
laid out in the [User Permissions](link/to/sprout/security#user-permissions) subsection.

For a detailed discussion of how the Seedcase framework ensures that only authorised users can update or transfer data, see the [Login and Authentication](link/to/sprout/runtime-view#login-and-authentication) section and the [Security](link/to/sprout/security) page. The endpoint
...
authentication as described on the [Security](link/to/sprout/security) page, as well as managing [user
permission](link/to/sprout/security#user-permissions) levels.
