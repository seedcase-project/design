...
be assigned, laid out in the [User
Permissions](link/to/sprout/security#user-permissions) subsection.
...
Authentication](link/to/sprout/runtime-view#login-and-authentication)
section and the [Security](link/to/sprout/security) page. The endpoint
...
authentication as described on the [Security](link/to/sprout/security)
page, as well as managing [user
