...
and describes the contents within each main part, but only as black
boxes.
...
framework.](/design/images/container.png)
...
: Core internal parts of the Seedcase framework (as black boxes).
...
-   **Web Interface**: This is the interface that users will interact
    ...
    <!-- TODO: Insert real link to Sprout below -->
-   **User Authentication**: This is the part that handles
    authenticating users who log into the Web Portal of the Data
    Resource instance managed by the Seedcase framework. Depending on
    the user's assigned permissions, they will see different pages
    within the Web Interface. For a more detailed description of the login process, see the
[Login](link/to/sprout/runtime-view#login-and-authentication) section.
...
interface.](/design/images/component-ui.png)
