...
To accomplish the features described above, we have to decide what
main technologies and what architectural designs to use. Any technologies we decide must
adhere to the [Guiding principles](principles.qmd).
