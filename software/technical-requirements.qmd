...
decide must adhere to the [Guiding principles](principles.qmd).
...
Following our guiding principles, we have the following technical
constraints of the Seedcase framework:
...
| Use [SemVar](https://semver.org/) versioning                                                                               | We can utilise existing tools to handle tasks like version release and changelog generation. See our [decision post](https://decisions.seedcase-project.org/why-semver) on this |
