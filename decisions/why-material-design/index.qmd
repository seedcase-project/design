...
- Bootstrap. The oldest and most widely used CSS framework. It is often used together with Django and there even exist a Python package for this purpose called `django-bootstrap5`
...
- We think it looks better than the other frameworks, which was the main driver for selecting Material Design
...
Reasons for not selecting the other frameworks
- Bootstrap has great integration with Django, but we think Material Design looks better 
- Tailwind require time and skill to customize, and it relies on nodejs/npm which gives a bad developer experience
