...
description: "We want to Seedcase to look good with a minimal effort."
...
Seedcase should look good with a minimal effort. Therefore, we want to leverage existing CSS or UI frameworks rather than starting from scratch. 
...
- Be easy to use with Django. Since Django is a python framework, we don't want to rely on frameworks that requires node/npm or too much javascript. Preferably, we want a CSS framework, where we can just add CSS classes to html elements
