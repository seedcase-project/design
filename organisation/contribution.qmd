...
build, document, and develop having the perspective that others will use
the products too.
...
to have focused, intensive periods of work on as few projects in any
...
topic or if documentation doesn't exist on something, we aim to
...
[DevOps](https://en.wikipedia.org/wiki/DevOps), the
["platform"](https://en.wikipedia.org/wiki/Platform_engineering), and
security practices.
