...
producing is described by this observation:
...
or produces. This is why we want to be intentional about how we
structure our teams, and leads to the following organisation design
principles.
...
To achieve the idea that teams are the means of delivery, it means we
need create teams based on what a project or product needs in order to
...
includes some type of product. For instance, a project may be to get to
the first minimum viable product (MVP) of a new product or to implement
...
to fulfill the needs and requirements of the project. Design the team
*before* fitting people into it.

This team is now tied to that project. When the project ends, the team
disbands and converts into another team for another project. Often this
team stays the same, but it doesn't have to.

## Teams are responsible for the *full* lifecycle of their project

In order be able to effectively and practically complete a project, the
...
responsible for the ongoing maintenance of the product that is the aim
...
team, not the other way around. In that way, individuals fit the needs
of the team. We build teams to contain individuals with the necessary
...
overwhelming, with a preference toward lower cognitive load and higher.
...
if people in the teams are constantly coming in or going out. Therefore,
we aim to create teams that are long-lasting and stable. This doesn't
mean that the team is unchanging, but that the team is stable enough to
build trust and comfort with one another.

Which also means that projects need to be scoped large enough to allow a
longer lasting team. Alternatively, the people that make up the teams
are all familiar and comfortable enough with each other so that a stable
