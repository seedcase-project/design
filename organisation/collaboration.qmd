...
of external contributors, culture can change quite a fair amount. Many
of these dynamics might happen through channels like in-person
...
Humans are biological beings with limitations to their capacities with
physical, emotional, and mental needs. Part of designing a
...
capacity when planning and designing products, and where we incorporate
...
should be kept private, which will be decided on a per-situation basis.
...
in a given day. There will always be more tasks than we can reasonably
...
Adaptability and flexibility are critical to not only surviving but growing. However,
...
automate or simplify things and to improve documentation and
collaboration.
...
communication is more accessible and easier to engage with and come back to. Sharing
...
communicate in as asynchronous a manner as possible and reasonable.
